...
/// @nodoc
mixin _$SplashState {
  bool get navigated => throw _privateConstructorUsedError;
...
class _$SplashStateCopyWithImpl<$Res, $Val extends SplashState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      navigated: null == navigated
          ? _value.navigated
          : navigated // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$SplashStateImpl extends _SplashState {
  _$SplashStateImpl({this.navigated = false}) : super._();
  ...
  @override
  String toString() {
    return 'SplashState(navigated: $navigated)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.navigated, navigated) ||
                other.navigated == navigated));
  }

  @override
  int get hashCode => Object.hash(runtimeType, navigated);
...
abstract class _SplashState extends SplashState {
  factory _SplashState({final bool navigated}) = _$SplashStateImpl;
