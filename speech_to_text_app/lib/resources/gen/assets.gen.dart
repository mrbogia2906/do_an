...
class $AssetsAudioGen {
  ...
  /// File path: assets/audio/test.flac
  String get testFlac => 'assets/audio/test.flac';

  /// File path: assets/audio/test.wav
  String get testWav => 'assets/audio/test.wav';

  /// File path: assets/audio/test1.mp3
  String get test1 => 'assets/audio/test1.mp3';

  /// File path: assets/audio/test2.wav
  String get test2 => 'assets/audio/test2.wav';

  /// File path: assets/audio/test3.mp3
  String get test3 => 'assets/audio/test3.mp3';

  /// List of all assets
  List<String> get values => [testFlac, testWav, test1, test2, test3];
}

class $AssetsGoogleGen {
  const $AssetsGoogleGen();

  /// File path: assets/google/gen-lang-client-0446786270-0de2af86d9e3.json
  String get genLangClient04467862700de2af86d9e3 =>
      'assets/google/gen-lang-client-0446786270-0de2af86d9e3.json';

  /// List of all assets
  List<String> get values => [genLangClient04467862700de2af86d9e3];
}
...
class Assets {
  ...
  static const $AssetsGoogleGen google = $AssetsGoogleGen();
